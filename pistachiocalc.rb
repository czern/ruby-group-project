...
def pist_dab
puts "how many pistachios have you eaten?"
pistachios = gets.chomp.to_i
puts "You should dab for #{pistachios * 180/175} minutes to burn that off. But also body positivity, so no pressure. We love you just the way you are!"
end
...
def pcalc(a,op,b)
    ...
    if op == "+"
        ...
        puts "Wrong cracking technique(operation)"
    end
    if op == "clear"
        a = 0
        b = 0
    ...
    until op == "clear"
        ...
        op = gets.chomp
            ...
            puts pist_dab
                ...
                puts "Please crack your second shell(number)."
                b = gets.chomp.to_f 
                pcalc(a,op,b)
            end
    end
